...
public class TypedValue {
    ...
    /**
     * The <var>data</var> field holds an attribute resource identifier (referencing an attribute in the
     * current theme style, not a resource entry).
     */
    public static final int TYPE_ATTRIBUTE = 0x02;
    /**
     * The <var>string</var> field holds string data. In addition, if <var>data</var> is non-zero then it is
     * the string block index of the string and <var>assetCookie</var> is the set of assets the string came
     * from.
     */
    ...
    /**
     * Identifies the start of plain integer values. Any type value from this to {@link #TYPE_LAST_INT} means
     * the <var>data</var> field holds a generic integer value.
     */
    ...
    /**
     * Complex data: mask to extract unit information (after shifting by {@link #COMPLEX_UNIT_SHIFT}). This
     * gives us 16 possible types, as defined below.
     */
    ...
    /**
     * Complex data: mask to extract radix information (after shifting by {@link #COMPLEX_RADIX_SHIFT}). This
     * give us 4 possible fixed point representations as defined below.
     */
    ...
    /**
     * Complex data: mask to extract mantissa information (after shifting by {@link #COMPLEX_MANTISSA_SHIFT}).
    ...
    /**
     * If {@link #density} is equal to this value, then the density should be treated as the system's default
     * density value: {@link DisplayMetrics#DENSITY_DEFAULT}.
     */
    public static final int DENSITY_DEFAULT = 0;

    /**
     * If {@link #density} is equal to this value, then there is no density associated with the resource and
    ...
    /**
     * The type held by this value, as defined by the constants here. This tells you how to interpret the
    ...
    /**
     * Retrieve the base value from a complex data integer. This uses the {@link #COMPLEX_MANTISSA_MASK} and
     * {@link #COMPLEX_RADIX_MASK} fields of the data to compute a floating point representation of the number
     * they describe. The units are ignored.
     * 
     * @param complex
