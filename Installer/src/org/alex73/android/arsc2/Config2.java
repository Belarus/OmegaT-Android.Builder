...
public class Config2 {
    ...
    public Config2(ChunkMapper in, Package2 pkg) {
        this.rd = in.clone();
    ...
    public Entry2 getEntry(int index) {
        ...
        return new Entry2(rd, mResId, parent.getParentPackage().getSpecNames());
    }
    ...
    public Config2 duplicate() {
        ...
        return new Config2(new ChunkMapper(data, 0), parent.getParentPackage());
    }
}
